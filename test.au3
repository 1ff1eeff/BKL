...
$exeName		= "C:\Users\Андрей\Desktop\subkey.exe"		;путь к исполняемому файлу приложения создающего ключи
...
$someNumber 	= "3018" 			;какое-то число
$orgName 		= "Owen" 		    ;название организации
$keyFile		= "E:\Lectus\Source_key_opcserv_02\opcserv.key"	;имя файла с ключом
$archName		= "E:\Lectus\Disk_Lectus_05\opckey.exe"				;имя для будущего sfx-архива
$programDir		= "E:\Lectus\Disk_Lectus_05" 							;каталог назначения для архива с ключом
